...
export const adminSections: HelpSection[] = [
  ...
  },
  {
    ...
    title: "受講者を管理する",
    roles: ["admin"],
    keywords: ["受講者", "ユーザー", "管理", "登録", "一覧", "CSV", "インポート", "ロール", "削除"],
    description: "受講者の登録・ロール変更・CSV一括インポート・削除の方法を説明します。",
    screenshots: [],
    steps: [
      {
        title: "受講者管理ページを開く",
        detail: "ナビゲーションから「受講者管理」を選択します。登録済みの受講者一覧（名前・メール・ロール・作成日）が表示されます。",
      },
      {
        title: "受講者を個別追加する",
        detail: "「ユーザー追加」ボタンからメールアドレス・名前・ロールを入力して追加します。許可メールリストにも自動登録されます。",
      },
      {
        title: "CSVで一括インポートする",
        detail: "「CSVインポート」ボタンからCSVファイルを選択してインポートします。「テンプレートCSVをダウンロード」でサンプルCSVを取得できます。CSVにはemail列（必須）、name列・role列（任意）を含めます。",
      },
      {
        title: "ロールを変更する",
        detail: "一覧のロール列にあるドロップダウンから、受講者・管理者・スーパー管理者のいずれかに即座に変更できます。",
      },
      {
        title: "受講者を削除する",
        detail: "操作列の「削除」ボタンから受講者を削除できます。削除すると許可メールリストからも同時に削除され、再ログインによる復活を防止します。",
      },
    ],
    callouts: [
      {
        ...
        title: "進捗の確認",
        content:
          "受講者の進捗状況は「分析」ページの「コース進捗」「受講者進捗」タブで確認できます。",
      },
    ],
  },
  {
    ...
    callouts: [
      {
        ...
        title: "注意",
        content:
          "許可メール管理ページからメールアドレスを削除しても、既にログイン済みの受講者のデータは残ります。受講者ごと完全に削除したい場合は、受講者管理ページから削除してください（許可メールも同時に削除されます）。",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        title: "出席管理タブ",
        detail:
          "レッスン別の入退室記録を確認できます。入室時刻、退室時刻、ステータス、退室理由、所要時間が表示されます。CSVエクスポートも可能です。",
      },
    ],
    callouts: [
      {
