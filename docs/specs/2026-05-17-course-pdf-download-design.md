...
| # | 要件 |
|---|---|
| F-1 | super-admin はマスターレッスンに PDF (最大 300 MB) を 1 個アップロードできる |
...
- `sizeBytes <= 300 * 1024 * 1024` (300 MB、2026-06-19 改訂、旧 150 MB / 2026-06-18 改訂で 50 MB → 150 MB)
...
| `file_too_large` | sizeBytes > 300 MB | 400 | "300 MB を超えるファイルはアップロードできません" | permanent |
...
| AC-10 | サイズ上限 | sizeBytes > 300MB → 400 file_too_large |
